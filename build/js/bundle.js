...
/******/ 	var hotCurrentHash = "c05dd334f9d65d242e43"; // eslint-disable-line no-unused-vars
...
function createRelationPath(outputId, inputId) {
    ...
    path.attr('d', (0, _feature.curveTo)(x1, y1, x2, y2));
...
function batteryDown(that, event) {
    ...
    $(document).on('mousemove', function (event) {
        ...
        inputPaths.each(function (index, elem) {
            ...
            elem.setAttribute('d', (0, _feature.curveTo)(inputM[0], inputM[1], inputX, inputY));
            elem.setAttribute('end', inputX + ',' + inputY);
            elem.setAttribute('move', 'true');
        });
        outputPaths.each(function (index, elem) {
            var outputM = pathsOutputM[index].split(',');
            elem.setAttribute('d', (0, _feature.curveTo)(outputX, outputY, outputM[0], outputM[1]));
...
function outputDown(event) {
    ...
    $(document).on('mousemove', function (event) {
        currPath.attr('d', (0, _feature.curveTo)(tempX, tempY, event.clientX, event.clientY));
    });
...
var relations;
$(document).on('dblclick', '#svg', function (e) {
